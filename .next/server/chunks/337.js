...
/* harmony export */   "nq": () => (/* binding */ updateProfileValidationSchema),
...
const updateProfileValidationSchema = zod__WEBPACK_IMPORTED_MODULE_0__.z.object({
  username: zod__WEBPACK_IMPORTED_MODULE_0__.z.string().min(1, 'ユーザー名は1文字以上で入力してください').max(15, 'ユーザー名は15文字以下で入力してください').optional(),
  description: zod__WEBPACK_IMPORTED_MODULE_0__.z.string().max(50, '自己紹介は50文字以下で入力してください').optional()
});
