...
const UpdatePostPage = () => {
  ...
  const { handleUpdatePost } = useUpdatePost(setIsLoadingSubmission);
            ...
            <SLabel htmlFor="textForm">
              <SForm
                ...
                onSubmit={handleSubmit((data) =>
                  handleUpdatePost(postId as any, data.desc as any),
                )}
              >
                <TextArea
                  {...register('desc')}
...
const SPostHeader = styled.header`
  background-color: #fff;
`;
const SPostButton = styled.button<{ isText: boolean }>`
  background-color: #fff;
